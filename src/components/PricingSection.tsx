...
const plans = [
  {
    ...
    features: [
      ...
      { name: 'Интеграция с МП (только выгрузка)', available: true },
      { name: '1 пользователь (3 сессии)', available: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Интеграция с МП (только выгрузка)', available: true },
      { name: 'До 5 сотрудников (3 сессии)', available: true },
      { name: 'Работа с веткой компании', available: true },
      { name: 'Делегирование прав', available: true },
      { name: 'Unit-экономика', available: true },
      { name: 'Подбор товаров (до 3/день)', available: true },
      { name: 'Аналитика артикула (до 3/день)', available: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'До 15 сотрудников (3 сессии)', available: true },
      { name: 'Работа с веткой компании', available: true },
      { name: 'Делегирование прав', available: true },
      { name: 'Unit-экономика', available: true },
      { name: 'Подбор товаров (до 5/день)', available: true },
      { name: 'Аналитика артикула (до 5/день)', available: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Полная интеграция с МП', available: true },
      { name: 'До 100 сотрудников (3 сессии)', available: true },
      { name: 'Работа с веткой компании', available: true },
      { name: 'Делегирование прав', available: true },
      { name: 'Тйм-менеджмент', available: true },
      { name: 'Unit-экономика', available: true },
      { name: 'Подбор товаров (до 30/день)', available: true },
      { name: 'Аналитика артикула (до 30/день)', available: true },
      { name: 'Оптимизация рекламных расходов', available: true },
      { name: 'Отчёт по номенклатурам', available: true },
    ],
  },
